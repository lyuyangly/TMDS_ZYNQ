...
void FsblHandoff(u32 FsblStartAddr)
{
	...
	for (x = 0; x < 1280; x++) {
		for (y = 0; y < 720; y++) {
			if (x < 160 * 1)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0xffffff;
			else if (x < 160 * 2)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0xffff00;
			else if (x < 160 * 3)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0xff00ff;
			else if (x < 160 * 4)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0xff0000;
			else if (x < 160 * 5)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0x00ffff;
			else if (x < 160 * 6)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0x00ff00;
			else if (x < 160 * 7)
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0x0000ff;
			else
				*((volatile uint32_t *)((x + y * 1280)*4 + 0x30000000)) = 0x000000;
		}
	}
	...
	if(BitstreamFlag) {
		...
		Xil_Out32(FPGA_RESET_REG, 0xF);
		usleep(500000);
		Xil_Out32(FPGA_RESET_REG, 0x0);
